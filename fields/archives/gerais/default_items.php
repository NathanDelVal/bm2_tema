<?php
	...
	function create_posttype_gerais() {
		...
		*/
		...
		if(!get_page_by_path( 'configuracoes-de-smtp', OBJECT, 'gerais' )){
			$dataToInsert = array(
									'post_title'	=> 'Configurações de SMTP',
									'post_name'		=> 'configuracoes-de-smtp',
									'post_status'	=> 'publish',
									'post_type'		=> 'gerais',
									'post_author'   => '1'
								);
